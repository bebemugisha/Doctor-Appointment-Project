          ...
          {/*======= about content =========*/}
             ...
             <div className='w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2'>
                ...
                <p className='text_para'>
                    For 30 years in a row, U.S. News a World Report has recognized us
                    as one of the best publics hospitals in the Nation and #1 in Texas.
                </p>

                <p className='text_para '>
                Our best is something we strive for each day, caring for
                our patients-not looking back at what we accomplished but 
                towards what we can do tomorrow. Providing the best.
                </p>
